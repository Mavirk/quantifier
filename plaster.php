<html lang="en" class="h-100">
    ...
    <body class="h-100">
        ...
        <?php
            ...
            session_start();
            if($_SESSION['userid']){
                $plasterController = new PlasterController();
                $homeController = new HomeController();
                $plasterController->addPlaster($_SESSION['userid']);
            }else {
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-9">
                        <form role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                            ...
                            <div class="form-group">
                                <input type="submit" name="addplaster" value="Add"/>
                            </div>
                        </form>
                    </div>
                    <div class="col-sm-9">
